...
export const ru: Dictionary = {
  ...
  'chat.empty': 'Разговоров пока нет. Начните один, чтобы поговорить с Pomni.',
  'chat.delete': 'Удалить',
  'chat.confirmDelete': 'Удалить чат «{title}»?',
  'chat.pickProvider': 'Провайдер…',
  'chat.pickModel': 'Модель…',
  'chat.startIt': 'Напишите что-нибудь ниже, чтобы начать.',
  'chat.nextTurn': 'Применится со следующего хода.',
  'chat.placeholder': 'Сообщение для Pomni…',
  'chat.saySomething': 'Напишите что-нибудь, чтобы начать.',
  ...
  'chat.action.writeTag': 'изменение в вашем рабочем пространстве',
  'chat.action.running': 'выполняется…',
  'chat.action.expanded': 'Открыты действия группы «{group}».',
  'chat.action.rejectedNote': 'Отклонено — ничего не выполнено.',
  'chat.addressRule':
    'Пишите #проект, @агент или /скилл в начале слова — после пробела или с новой строки. У @ допустима форма воркфлоу/агент; # и / не могут содержать слэш; всё внутри обратных кавычек не трогается.',
  ...
  'comments.placeholder': 'Что нужно знать следующей попытке?',
  'comments.author': 'Ваше имя',
  'comments.addressedTo': 'Спросить кого-то (необязательно)',
  'comments.write': 'Написать',
  'comments.person': '(человек)',
  'comments.waiting': 'ждёт',
  'comments.answered': 'отвечено',
  'comments.withdraw': 'Отозвать',
  'comments.withdrawn': 'Отозвано.',
  'comments.attached': 'Вложения',
  ...
  'workflows.import': 'Импортировать',
  'workflows.new': 'Новый воркфлоу',
  'workflows.newTitle': 'Новый воркфлоу',
  'workflows.noCredentials':
    'Доступов к моделям нет — {auth}. Агентов можно писать и без них, но для генерации промпта или запуска пайплайна они нужны.',
  'workflows.empty':
    'Пайплайнов пока нет. Воркфлоу — это один оркестратор, который планирует и делегирует, плюс агенты, которых он может позвать.',
  'workflows.in': 'Вход',
  'workflows.out': 'Выход',
  'workflows.name': 'Название',
  'workflows.purpose': 'Для чего он',
  'workflows.suits': 'Подходит для',
  'workflows.suitsPlaceholder': 'баг, регрессия, хотфикс',
  'workflows.suitsHint':
    'Подсказки через запятую. Когда задача не называет воркфлоу, их сопоставляют с текстом задачи, чтобы выбрать один.',
  'workflows.importTitle': 'Импортировать воркфлоу',
  'workflows.file': 'Файл',
  'workflows.orPaste': 'Или вставьте текстом',
  'workflows.export': 'Экспортировать',
  'workflows.addAgent': 'Добавить агента',
  'workflows.delete': 'Удалить',
  'workflows.howItRuns': 'Как он работает',
  'workflows.inAndOut': 'Вход и выход',
  'workflows.outNothing': 'Ничего — это конец',
  'workflows.outHint':
    'Когда этот пайплайн заканчивается, его результат — то, с чего начинает следующий, в своём проекте, который обычно другой.',
  'workflows.toFix': 'Исправить, прежде чем это запустится',
  'workflows.orchestrator': 'Оркестратор',
  'workflows.agents': 'Агенты',
  'workflows.addAgentTitle': 'Добавить агента',
  'workflows.role': 'Роль',
  'workflows.modelScale': 'Шкала моделей',
  'workflows.provider': 'Провайдер',
  'workflows.resolvesTo': 'На {provider} «{level}» разрешается в {model}.',
  'workflows.noModelConfigured': 'У {provider} не настроена модель ни для одного уровня.',
  'workflows.pickProvider': 'Выберите провайдера, чтобы увидеть, в какую модель разрешается каждый уровень.',
  'workflows.needsClaudeCode':
    ' Этот агент читает и пишет файлы, запускает команды или ищет в вебе — поэтому работать он может только на провайдере claude-code.',
  'workflows.produces': 'Что он выдаёт',
  'workflows.producesPlaceholder': 'Унифицированный дифф / причина со ссылками на файлы',
  'workflows.mayUse': 'Чем ему можно пользоваться',
  'workflows.useFiles': 'читать и писать файлы',
  'workflows.useRun': 'запускать команды',
  'workflows.useWeb': 'искать в вебе',
  'workflows.spec': 'Спецификация — что делает этот агент, вашими словами',
  'workflows.specPlaceholder':
    'Дан падающий тест и репозиторий — найди причину. Прочитай тест, прочитай код, который он задействует, и назови конкретную строку, в которой дело. Чинить не предлагай.',
  'workflows.generating': 'Пишем промпт…',
  'workflows.generate': 'Сгенерировать промпт',
  'workflows.prompt': 'Системный промпт — то, что получает модель',
  'workflows.promptPlaceholder': 'Сгенерируется из спецификации, или напишите сами.',
  'workflows.attach': 'Подключить',
  'workflows.detach': 'Отключить',
  'workflows.attachTitle': 'Подключить воркфлоу',
  'workflows.nothingToAttach': 'Подключать больше нечего.',
